...
public class Controller
{
    ...
    private float getReturnedThumbstickValue(float value)
    {
    ...
    public float getLThumbStickXValue()
    {
        ...
        return getReturnedThumbstickValue(this.controller.getAxis(axis) * (this.isFlipLeftX() ? -1 : 1));
    }
    ...
    public float getLThumbStickYValue()
    {
        ...
        return getReturnedThumbstickValue(this.controller.getAxis(axis) * (this.isFlipLeftY() ? -1 : 1));
    }
    ...
    public float getRThumbStickXValue()
    {
        ...
        return getReturnedThumbstickValue(this.controller.getAxis(axis) * (this.isFlipRightX() ? -1 : 1));
    }
    ...
    public float getRThumbStickYValue()
    {
        ...
        return getReturnedThumbstickValue(this.controller.getAxis(axis) * (this.isFlipRightY() ? -1 : 1));
    }
